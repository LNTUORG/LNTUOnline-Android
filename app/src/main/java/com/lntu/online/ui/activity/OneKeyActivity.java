...
import com.lntu.online.ui.adapter.OneKeyAdapter;
...
public class OneKeyActivity extends BaseActivity {
    ...
    private void startNetwork() {
        HttpUtil.get(this, "oneKey/info", new RetryAuthListener(this) {
    ...
    private void startEvaAsyncTask(final List<EvaInfo> evaInfos, final int current) {
        if (current == evaInfos.size()) { //评价已经完成
            ...
            if (TextUtils.isEmpty(evaInfo.getUrl())) { //不需要评价，跳过
                ...
                HttpUtil.post(this, "oneKey/evaluateOne", params, new NormalAuthListener(this, "正在评价：\n" + evaInfo.getCourse()) {
